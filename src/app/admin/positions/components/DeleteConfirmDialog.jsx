...
export default function DeleteConfirmDialog({ isOpen, onClose, onConfirm, position, isDeleting }) {
  return (
                ...
                <div className="p-6">
                  <div className="mb-4">
                    <p className="text-sm text-gray-600">
                      ທ່ານຕ້ອງການລຶບຕຳແໜ່ງ <span className="font-medium text-gray-900">{position?.title_lo || position?.title || position?.code}</span> ຫຼື ບໍ່?
                    </p>
